...
class KssSection {
  ...
  /**
   * Gets or sets the programs of the section.
   *
   * If the `programs` value is provided, the `programs` for this section is set.
   * Otherwise, the `programs` of the section is returned.
   *
   * @param {Array} [programs] Collection of color object.
   * @returns {KssSection|string|boolean} If `programs` is given, the `KssSection` object is
   *   returned to allow chaining of methods. Otherwise, the programs of the section
   *   is returned, or `false` if none.
   */
  programs(programs) {
