...
class KssSection {
  ...
  /**
   * Gets or sets the gradients of the section.
   *
   * If the `gradients` value is provided, the `gradients` for this section is set.
   * Otherwise, the `gradients` of the section is returned.
   *
   * @param {Array} [gradients] Collection of gradient objects.
   * @returns {KssSection|string|boolean} If `gradients` is given, the `KssSection` object is
   *   returned to allow chaining of methods. Otherwise, the gradients of the section
   *   is returned, or `false` if none.
   */
  gradients(gradients) {
    if (typeof gradients === 'undefined') {
      return this.data.gradients;
    }
  ...
  /**
   * Gets or sets the icons of the section.
   *
   * If the `icons` value is provided, the `icons` for this section is set.
   * Otherwise, the `icons` of the section is returned.
   *
   * @param {Array} [icons] Collection of color object.
   * @returns {KssSection|string|boolean} If `icons` is given, the `KssSection` object is
   *   returned to allow chaining of methods. Otherwise, the icons of the section
   *   is returned, or `false` if none.
   */
  icons(icons) {
  ...
  /**
   * Gets or sets the svgIcons of the section.
   *
   * If the `svgIcons` value is provided, the `svgIcons` for this section is set.
   * Otherwise, the `svgIcons` of the section is returned.
   *
   * @param {Array} [svgIcons] Collection of svgIcons objects.
   * @returns {KssSection|string|boolean} If `svgIcons` is given, the `KssSection` object is
   *   returned to allow chaining of methods. Otherwise, the svgIcons of the section
   *   is returned, or `false` if none.
   */
  svgIcons(svgIcons) {
    if (typeof svgIcons === 'undefined') {
      return this.data.svgIcons;
    }
    this.data.svgIcons = svgIcons;
    // Allow chaining.
    return this;
  }

  /**
   * Gets or sets the contrast of the section.
   *
   * If the `contrast` value is provided, the `contrast` for this section is set.
   * Otherwise, the `contrast` of the section is returned.
   *
   * @param {Array} [contrast] Collection of color object.
   * @returns {KssSection|string|boolean} If `contrast` is given, the `KssSection` object is
   *   returned to allow chaining of methods. Otherwise, the contrast of the section
   *   is returned, or `false` if none.
   */
  contrast(contrast) {
